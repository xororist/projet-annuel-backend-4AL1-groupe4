        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center ml-auto">
            <div className="flex flex-row">
              <a href="/home" className="text-gray-400 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={handleHomeClick}>Home</a>
              {!user && <a href="/login" className="text-gray-400 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Login</a>}
              <a href="/editor" className="text-gray-400 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Editor</a>
            </div>
            {user && (
                <>
            ...
            <button onClick={toggleDarkMode} className="ml-4 focus:outline-none">
              <FaMoon className={`inline-block ${darkMode ? 'text-white' : 'text-gray-400'}`} style={{ fontSize: '1.5rem' }} />
            </button>
          </div>
        </div>
      </nav>
